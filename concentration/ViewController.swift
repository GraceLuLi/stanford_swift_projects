...
class ViewController: UIViewController {
    ...
    //Concentration is class, it gets a free init when all its
    // instance got initialized
    var game = Concentration(numberOfPairsOfCards: 6)
    //TODO: even with lazy, it has the problem, why?
    ...
    @IBAction func touchCard(_ sender: UIButton) {
        ...
        if let cardNumber = cardButtons.index(of: sender) {
            ...
            print("choosed card is not in cardButton");
        }
    }
